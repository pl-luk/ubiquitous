...
#' @param alphabet The alphabet the sequence should be based on as a vector
#' @param length The length of the generated sequence as an integer
#' @param matrix The transition matrix so that rows and columns are named by their respective letters which can be accomplished by \link{base}{colnames} and
#' \link{base}{rownames}. \code{matrix[i, j]} describes the probability that a state \eqn{i} is followed by state \eqn{j}
